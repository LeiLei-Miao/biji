...
1.打开网址 [The Comprehensive R Archive Network](The Comprehensive R Archive Network)
...
1.打开网址 [RStudio – Open source and enterprise-ready professional software for R](RStudio – Open source and enterprise-ready professional software for R)

2.下载 *RStudio*，*Shiny*和*R Packages*两个暂时不用管

3.选择Free的第一个 [Download RStudio – RStudio](Download RStudio – RStudio)
